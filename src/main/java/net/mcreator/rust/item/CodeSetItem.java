...
import net.mcreator.rust.procedures.SetCodeProcedure;
import net.mcreator.rust.procedures.OuvrirGuiCodeProcedure;
...
public class CodeSetItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		SetCodeProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer(), context.getItemInHand());
