	...
	public static void execute(Entity entity) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initArrowProjectile(new GrenadeF1ProjectileEntity(RustModEntities.GRENADE_F_1_PROJECTILE.get(), 0, 0, 0, projectileLevel, createArrowWeaponItemStack(projectileLevel, (int) 0.2, (byte) 0)), entity, 1, true,
