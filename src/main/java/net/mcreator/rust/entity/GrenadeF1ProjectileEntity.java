...
public class GrenadeF1ProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public GrenadeF1ProjectileEntity(EntityType<? extends GrenadeF1ProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public GrenadeF1ProjectileEntity(EntityType<? extends GrenadeF1ProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static GrenadeF1ProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1f, 1, 5);
	}

	public static GrenadeF1ProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1f, 1, 5);
	}

	public static GrenadeF1ProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		GrenadeF1ProjectileEntity entityarrow = new GrenadeF1ProjectileEntity(RustModEntities.GRENADE_F_1_PROJECTILE.get(), entity, world, null);
	...
	public static GrenadeF1ProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		GrenadeF1ProjectileEntity entityarrow = new GrenadeF1ProjectileEntity(RustModEntities.GRENADE_F_1_PROJECTILE.get(), entity, entity.level(), null);
